  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <h1 className="mt-2 text-2xl font-semibold text-[var(--color-foreground)]">{t("displays.addDisplay")}</h1>
        <p className="mt-1 text-sm text-[var(--color-muted-foreground)]">{t("displays.createDescription")}</p>
      </div>
